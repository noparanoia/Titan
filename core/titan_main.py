...
def start_strategy(user_input):
    ...
    strategy = poc_strategy.PocStrategy(user_input[3], user_input[0], user_input[1], user_input[2],
                                        user_input[4], user_input[6], user_input[5], user_input[7])  # if test strategy button clicked
